      ...
      {items.length > 0 ?
        <div>
          ...
          <div className='flex items-center justify-center my-5'>
            <button className='flex items-center justify-center bg-blue-500 text-white py-3 px-3 text-2xl hover:bg-blue-800 ease-in-out transition duration-200 rounded-lg' onClick={handlePayment}>Proceed to Payment</button>
          </div>
        </div>
